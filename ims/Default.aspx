...
<head id="Head1" runat="server">
    <title>Collections - Incorrect Mortgage Status</title>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>Incorrect Mortgage Status (IMS)</h1>
    ...
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.collection_reports_nav_select_section("IMS", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <table class="table table-striped">
            ...
            <% foreach (com.sp.rmmc.collections.models.BaseBMS bf in bfs)
               {
            %>
            <tr> 
