...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected List<BaseBMS> bfs = new List<BaseBMS>();
    protected List<BaseBMS> all_bfs = new List<BaseBMS>();
    protected List<BaseBMS> accepted_bfs = new List<BaseBMS>();
    protected List<BaseBMS> removed_bfs = new List<BaseBMS>();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.workflow = getArg("workflow", "BMS");
    ...
    {
        bfs.Clear();
        foreach (BaseBMS bf in accepted_bfs)
        {
            bfs.Add(bf);
        }
    }
