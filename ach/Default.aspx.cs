...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        query_collection.getMonthCurrentWithRestrictAutopayDraft(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "ACH Restrict Autopay Draft ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#, Loan Name, Loan Type, Due Date of next payment, UPB, Restrict Autopay Draft, Stop Code", this.accepted_bfs);
    }
