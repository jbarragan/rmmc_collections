<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L606.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L606 Report</h1>
        <p>L606 All Other Mortgages in COVID-19 Related Forbearance that were Current when Placed in Forbearance (VA TXVET)</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L606", version, this.section)%>
        </div>
    </div>
