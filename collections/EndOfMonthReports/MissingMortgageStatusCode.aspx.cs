...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        query_collection.getFHACollectionsMissingMortgageStatusCode(accepted_bfs, removed_bfs);
    }
    ...
    protected void lbExport_Click(object sender, EventArgs e)
    {
        ...
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Agency Case Number,Due Date of next payment", this.accepted_bfs);
    }
