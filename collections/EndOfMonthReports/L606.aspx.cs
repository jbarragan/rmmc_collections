...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        forberance_query.getVaTexasVetFromToDates(quarter_start, quarter_end, accepted, removed);
        forberance_query.getVaTexasVetFromToDates(previous_quarter_start, previous_quarter_end, previous_quarter_accepted, previous_quarter_removed);

        this.all_current.start_date = quarter_start;
        this.all_current.end_date = quarter_end;
        foreach (BaseForbearance f in accepted)
        {
        ...
        foreach (BaseForbearance f in previous_quarter_accepted)
        {
