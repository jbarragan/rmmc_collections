<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L605.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L605 Report</h1>
        <p>L605: Residential First Mortgages (1-4 Residential) in COVID-19 related Forebearance that were Current when Placed in Forebearance</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L605", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div id="current_cnv" style="display:none">
     ...
     <div class="row">
        ...
        <asp:LinkButton ID="lbExportAllPrevious" runat="server" Text="Export" onclick="lbExport_ClickAllPrevious"></asp:LinkButton>
        ...
        <div id="previous_cnv" style="display:none">
