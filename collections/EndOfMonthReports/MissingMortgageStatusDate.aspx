<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissingMortgageStatusDate.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>End of Month Reports - FHA Missing Mortgage Status Date </h1>
    ...
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.end_of_month_reports_nav_select_section("Missing Mortgage Status Date", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
        <h2>FHA Missing Mortgage Status Date (<%= accepted_bfs.Count%>)</h2>
