<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LMCodes.aspx.cs" Inherits="lossmitigation_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Collections - End Of Month Reports - FHA Loss Mitigation Codes</title>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>End of Month Reports - FHA Loss Mitigation Codes </h1>
    ...
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.end_of_month_reports_nav_select_section("LM Codes", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
        <h2>FHA Loss Mitigation Codes (<%= accepted_bfs.Count%>)</h2>
