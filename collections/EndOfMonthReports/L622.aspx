...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L622.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L622 Report</h1>
        <p>Description: L622 Forbearance Loans – Ginnie Mae – 90 or More Days Delinquent</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L622", version, this.section)%>
        </div>
    </div>
