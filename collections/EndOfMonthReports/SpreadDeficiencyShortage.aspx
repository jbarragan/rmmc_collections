<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpreadDeficiencyShortage.aspx.cs" Inherits="lossmitigation_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Collections - End Of Month Reports - Spread Deficiency/Shortage Report</title>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>End of Month Reports - Spread Deficiency/Shortage Report</h1>
        <p></p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.end_of_month_reports_nav_select_section("Spread Deficiency/Shortage", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
        <h1>Spread Deficiency/Shortage Report (<%= this.accepted_bfs.Count %>)</h1>
        ...
        <div style="display:block;">
            ...
            <table class="table table-striped">
                ...
                <% foreach (com.sp.rmmc.collections.models.BaseModification bf in accepted_bfs)
                   {
                %>
                <tr>
                    <td><%= bf.loan_id.ToString()%></td>
                    <td><%= bf.loan.loan_name%></td>
                    <td><%= bf.modification_alerts %></td>
    ...
    <div class="row">
        ...
        <p>
            ...
            <b>Spread Deficiency/Shortage Documentation</b>
            </h3>
            <a href="#list">View List</a><br /><br />
            <a href="images/SPREAD_DEFICIENCY_Report.docx">Requirements</a>
        </p>
        </div>
    </div>
