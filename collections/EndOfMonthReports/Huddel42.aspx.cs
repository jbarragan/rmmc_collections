...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        query_collection.getFHAExCollectionsHUDDEL42(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "FHA HUDDEL42 ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Mortgage Status Code,Mortgage Status Date,Due Date of next payment,Paid Date", this.accepted_bfs);
    }
