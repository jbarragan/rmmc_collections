<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L611.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L611 Report</h1>
        <p>L611: Forbearance Loans - Fannie Mae - 60 days Delinquent</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L611", version, this.section)%>
        </div>
    </div>
