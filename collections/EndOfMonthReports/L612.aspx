<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L612.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L612 Report</h1>
        <p>L612: Forbearance Loans - Fannie Mae - 90 or More Days Delinquent</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L612", version, this.section)%>
        </div>
    </div>
