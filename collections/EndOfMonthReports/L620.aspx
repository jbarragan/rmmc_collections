...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L620.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L620 Report</h1>
        <p>Description: L620 Forbearance Loans – Ginnie Mae – 30 days Delinquent</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L620", version, this.section)%>
        </div>
    </div>
