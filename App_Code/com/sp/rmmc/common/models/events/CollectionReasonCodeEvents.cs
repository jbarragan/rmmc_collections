...
namespace com.sp.rmmc.common.models.events
{
    public class CollectionReasonCodeEvents : BaseEvents
    {
        ...
        //private static String filter_by_date = " and memo_create_dt < '2019-02-28' ";
        private static String filter_by_date = "";

        private static String[] class_fields = 
        {
            "ms_loan_information.loan_id as reason_code_events_loan_id ",
            "ms_credit_information.default_reason_code as reason_code_events_reason_code ",
            "memo_last_not_031_reason_code_data.memo_category_desc as reason_code_events_last_memo_reason_code ",
            "memo_last_031_reason_code_data.memo_create_dt as reason_code_events_memo_create_dt ",
            "memo_last_not_031_reason_code_data.memo_create_dt as reason_code_events_not_031_memo_create_dt ",
            "memo_last_0_reason_code_data.memo_category_desc ",
            "ms_credit_information.mortgage_status as reason_code_events_mortgage_status ",
        };
        /*
        ...
        {
            if (this.loan_id == 126928M)
                this.loan_id = 126928M;
            if (this.loan_id == 157441M)
            {
                this.loan_id = 157441M;
                //this.reason_code = "03";
            }
