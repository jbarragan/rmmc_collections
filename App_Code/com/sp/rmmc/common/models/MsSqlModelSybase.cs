...
{
    public class MsSqlModelSybase : DbModel
    {
        //public static string connectionString = @"Data Source=fics_server_any5;Provider=SAOLEDB.12";
        public string connectionString = @"Data Source=ficssql;Initial Catalog=fics;User ID=Dbguy;Password=myfwXyx%7tU#;";
        public SqlConnection connection = null;
        public string error = "";

        public MsSqlModelSybase()
        {
