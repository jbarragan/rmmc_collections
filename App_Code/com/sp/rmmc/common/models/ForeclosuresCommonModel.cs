...
{
    public class ForeclosuresCommonModel
    {
        ...
        public ForeclosuresCommonModel()
        {
        }
        ...
        protected static string getTableOpenRow(string cssClass)
        {
            return @"<tr class=""" + cssClass + @""">";
        }

        protected static string getTableCloseRow()
        {
            return @"</tr>";
        }

        protected static string addAnEnter()
        {
            return @"
";
        }
        ...
        protected static string toDBString(string s)
        {
            string r = "'" + s.Replace("'", "''") + "'";
            return r;
        }
