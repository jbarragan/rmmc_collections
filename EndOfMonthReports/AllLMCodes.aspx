<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllLMCodes.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>End of Month Reports - ALL Loss Mitigation Codes </h1>
    ...
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.end_of_month_reports_nav_select_section("ALL LM Codes", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
        <h2>ALL Loss Mitigation Codes (<%= accepted_bfs.Count%>)</h2>
