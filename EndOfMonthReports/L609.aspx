<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L609.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L609 Report</h1>
        <p>L609: Forbearance Loans - Fannie Mae - Current</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L609", version, this.section)%>
        </div>
    </div>
