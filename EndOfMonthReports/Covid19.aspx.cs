...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        query_collection.getCovidInLossMitigation(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "COVID-19";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Loan Type,Mortgage Status Code,Default Reason Code,Mortgage Status Date,Due Date of next payment,End Date,Monthly Payment Amount,Unpaid Principal Balance", this.accepted_bfs);
    }
