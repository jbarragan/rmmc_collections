...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        query_collection.getFHACollectionsInLossMitigation(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "FHA Loss Mitigation Codes ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Mortgage Status Code,Mortgage Status Date,Due Date of next payment", this.accepted_bfs);
    }
