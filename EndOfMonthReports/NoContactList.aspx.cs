...
{
    protected string workflow = "No Contact List";
    ...
    protected List<BaseCollection> no_contact_list = new List<BaseCollection>();
    protected List<BaseCollection> removed_bfs = new List<BaseCollection>();
    protected History history = null;
    protected void Page_Load(object sender, EventArgs e)
    {
        this.workflow = getArg("workflow", "No Contact List");
        ...
        if (this.workflow == "No Contact List" || workflow == "All")
        {
            query_collection.getNoContacts(no_contact_list, removed_bfs);
            foreach (CollectionGroup group in groupCollections(no_contact_list))
            {
                group.populateTable(tblNoContactList);
            }
        }
    }
    ...
    public class CollectionGroup : List<BaseCollection>
    {
        ...
        public void lb_click(object sender, EventArgs e)
        {
            ...
            string filename = "No Contact List " + DateTime.Today.ToString("MMMM yyyy") + " on ";
            CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Loan Type,Due Date,Days Delinquent,UPB,Last Memo Created Date,Last Memo Type,Last Memo Category", this);
        }
        ...
        public HtmlTableRow getCollectionHeaderRow()
        {
            ...
            cell6.InnerHtml = "<b>Last Memo Created At</b>";
            row.Cells.Add(cell6);
            HtmlTableCell cell7 = new HtmlTableCell();
            cell7.InnerHtml = "<b>Last Memo Type</b>";
            row.Cells.Add(cell7);
            HtmlTableCell cell8 = new HtmlTableCell();
            cell8.InnerHtml = "<b>Last Memo Category</b>";
            row.Cells.Add(cell8);
            return row;
        }
        ...
        public HtmlTableRow getCollectionRow(BaseCollection c)
        {
            ...
            row.Cells.Add(cell5);
            HtmlTableCell cell6 = new HtmlTableCell();
            cell6.InnerHtml = c.last_memo_created_dt.ToShortDateString();
            row.Cells.Add(cell6);
            HtmlTableCell cell7 = new HtmlTableCell();
            cell7.InnerHtml = c.last_memo_type_desc;
            row.Cells.Add(cell7);
            HtmlTableCell cell8 = new HtmlTableCell();
            cell8.InnerHtml = c.last_memo_category_desc;
            row.Cells.Add(cell8);
            return row;
        }
    }
    ...
    protected void lbExportNoContactList_Click(object sender, EventArgs e)
    {
        string filename = "No Contact List " + DateTime.Today.ToString("MMMM yyyy") + " on ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Loan Type,Due Date,Days Delinquent,UPB,Last Memo Created Date,Last Memo Type,Last Memo Category", this.no_contact_list);
    }
