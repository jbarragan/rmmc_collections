...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        query_collection.getFHACollectionsMissingMortgageStatusDate(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "FHA Missing Mortgage Status Date ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Mortgage Status Code,Due Date of next payment", this.accepted_bfs);
    }
