...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L623.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L623 Report</h1>
        <p>Description: L623 Ginnie Mae COVID – 19 Related Forbearance that were Current when place in Forbearance - Total.</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L623", version, this.section)%>
        </div>
    </div>
