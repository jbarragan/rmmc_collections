<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Huddel42.aspx.cs" Inherits="lossmitigation_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Collections - End Of Month Reports - FHA HUDDEL42</title>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>End of Month Reports - FHA HUDDEL42 </h1>
    ...
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.end_of_month_reports_nav_select_section("HUDDEL42", version, this.section)%>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span12">
        <h2>FHA HUDDEL42 (<%= accepted_bfs.Count%>)</h2>
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><%= bf.last_current_paid_dt.ToShortDateString()%></td>
             </tr>
            <%
               }
            %>
