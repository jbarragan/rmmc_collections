...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        query_collection.getFHACollectionsMissingOccupancyCode(accepted_bfs, removed_bfs);
    }
    ...
    {
        string filename = "FHA Missing Occupancy Code ";
        CSVExport.writeHeadersAndCSV(filename, "Loan#,Loan Name,Due Date of next payment", this.accepted_bfs);
    }
