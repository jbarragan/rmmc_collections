...
public partial class lossmitigation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        forberance_query.getFromToDates(quarter_start, quarter_end, accepted, accepted);
        forberance_query.getFromToDates(previous_quarter_start, previous_quarter_end, previous_quarter_accepted, previous_quarter_accepted);
