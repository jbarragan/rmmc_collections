<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L607.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L607 Report</h1>
        <p>L607 Totals Loans in COVID-19 Forbearance (current – 90 or more days delinquent) when Placed in Forbearance.</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L607", version, this.section)%>
        </div>
    </div>
