...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L621.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L621 Report</h1>
        <p>Description: L621 Forbearance Loans – Ginnie Mae – 60 days Delinquent</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L621", version, this.section)%>
        </div>
    </div>
