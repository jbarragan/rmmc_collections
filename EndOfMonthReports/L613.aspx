<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L613.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L613 Report</h1>
        <p>L613: Fannie Mae COVID-19 Related Forbearance that were Current when Placed in Forbearance - Total</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L613", version, this.section)%>
        </div>
    </div>
