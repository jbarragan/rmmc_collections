<%@ Page Language="C#" AutoEventWireup="true" CodeFile="L608.aspx.cs" Inherits="lossmitigation_Default" %>
...
<body>
    ...
    <div class="hero-unit">
        ...
        <h1>L608 Report</h1>
        <p>L608: Agency Loans in COVID-19 related Forbearance that were Current when Placed in Forbearance</p>
    </div>
    <div class="row">
        <div class="span12">
            ...
            <%= com.sp.rmmc.collections.views.Navigations.mba_quarterly_reports_nav_select_section("L608", version, this.section)%>
        </div>
    </div>
